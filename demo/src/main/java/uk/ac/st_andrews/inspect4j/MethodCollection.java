...
/**
 * This class is used to collect all the methods from the AST and store them in
 * a list.
 */
public class MethodCollection {
    ...
    /**
     * This method is used to extract all the methods from the AST and store them in
     * a list.
     */
    ...
    /**
     * This method is used to add the variables to their corresponding parent
     * methods.
     * 
    ...
    /**
     * This method is used to add local classes to their corresponding parent
     * methods.
     * 
     * @param classes
     */
    ...
    /**
     * This method is used to add the interfaces to their corresponding parent
     * methods.
     * 
    ...
    /**
     * This method is used to add method references to their corresponding parent
     * methods.
     * 
    ...
    private static class MethodDeclarationCollector extends VoidVisitorAdapter<List<Method>> {
        /**
         * This method is used to visit the method declarations and store them as method
         * objects in the arraylist contained in the MethodCollection object.
         * 
         * @param methodDecl - The method declaration
         * @param collection - The list of methods contained in the MethodCollection
         *                   object
         */
        @Override
        ...
        /**
         * This method is used to visit the constructor declarations and store them as
         * method objects in the arraylist contained in the MethodCollection object.
         * 
         * @param methodDecl - The method declaration
         * @param collection - The list of methods contained in the MethodCollection
         *                   object
    ...
    private static HashSet<String> getReturnStatements(MethodDeclaration md) {
        ...
        return new HashSet<String>(returnPrinter.visit(md, rtns)); // here the subtree for the method declaration is
                                                                   // visited to collect the return statements
    }
